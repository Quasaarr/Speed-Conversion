...
# Convert and Print Loop
    if unit.upper() == "M":
        if desired_unit.upper() == "K":
            ...
            print(f"You were going {speed.__round__(accuracy)}mph!", line_break)
    if unit.upper() == "K":
        if desired_unit.upper() == "M":
            ...
            print(f"You were going {speed.__round__(accuracy)}km/h!", line_break)
    if unit.upper() == "KN":
        if desired_unit.upper() == "M":
            ...
            print(f"You were going {speed.__round__(accuracy)} knots!", line_break)
